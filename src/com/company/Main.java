...
public class Main {
    public static void main(String[] args) throws SQLException {
        ...
        //Etapa3
           ...
           SystemCon run =  new SystemCon();  //conectarea la baza de date

           //run.AddZiSalariu();
           //run.DeleteZiSalariu();
           //run.SelectZiSalariu();      //add,delete,select,update pentru clasa ZiSalariu
           //run.UpdateZiSalariu();


           //run.AddIngredient();
           //run.DeleteIngrediente();
           //run.SelectIngrediente();
           //run.UpdateIngrediente();          //add,delete,select,update pentru clasa Ingrediente



          //run.AddMeniu_final();
          //run.DeleteMeniu_final();
          //run.SelectMeniu_final();        // add,delete,select,update pentru clasa Meniu_final
          //run.UpdateMeniu_final();


          //run.AddAngajat();
          //run.DeleteAngajat();           //add,delete,select,update pentru clasa Angajat
          //run.SelectAngajat();
          //run.UpdateAngajat();
